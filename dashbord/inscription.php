<?php
    ...
    // Récupere le message stocké dans la session (si disponible)
    $message = isset($_SESSION['message']) ? $_SESSION['message'] : '';
    // Supprime le message après l'avoir affiché pour éviter qu'il persiste
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                        ...
                                        <select class="form-select rounded-5 pays" id="country" name="country" required></select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="produit" name="produit" placeholder="Type de produit vendu" required>
                                    </div>
                                </div>
