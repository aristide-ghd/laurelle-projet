<?php
    ...
    $message_name_produit_input = htmlspecialchars($_SESSION['message_name_produit_input'] ?? '', ENT_QUOTES, 'UTF-8');

    // Recuperer le message de succès stocké dans la session (si disponible)
    $message_name_produit_success = htmlspecialchars($_SESSION['message_name_produit_success'] ?? '', ENT_QUOTES, 'UTF-8');

    // Recuperer le message d'error stocké dans la session (si disponible)
    $message_name_produit_error = htmlspecialchars($_SESSION['message_name_produit_error'] ?? '', ENT_QUOTES, 'UTF-8');
