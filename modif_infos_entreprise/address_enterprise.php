<?php
    ...
    $message_address_entreprise_input = htmlspecialchars($_SESSION['message_address_entreprise_input'] ?? '', ENT_QUOTES, 'UTF-8');

    // Recuperer le message de succès stocké dans la session (si disponible)
    $message_address_entreprise_success = htmlspecialchars($_SESSION['message_address_entreprise_success'] ?? '', ENT_QUOTES, 'UTF-8');

    // Recuperer le message d'error stocké dans la session (si disponible)
    $message_address_entreprise_error = htmlspecialchars($_SESSION['message_address_entreprise_error'] ?? '', ENT_QUOTES, 'UTF-8');
    ...
    // Requete pour afficher ladresse de l'entreprise 
