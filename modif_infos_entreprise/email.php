<?php
    ...
    $message_email_input = isset($_SESSION['message_email_input']) ? $_SESSION['message_email_input'] : '';

    // Recuperer le message de succès stocké dans la session (si disponible)
    $message_email_success = isset($_SESSION['message_email_success']) ? $_SESSION['message_email_success'] : '';

    // Recuperer le message d'error stocké dans la session (si disponible)
    $message_email_error = isset($_SESSION['message_email_error']) ? $_SESSION['message_email_error'] : '';
