<?php
    ...
    $message_country_input = htmlspecialchars($_SESSION['message_country_input'] ?? '', ENT_QUOTES, 'UTF-8');

    // Recuperer le message de succès stocké dans la session (si disponible)
    $message_country_success = htmlspecialchars($_SESSION['message_country_success'] ?? '', ENT_QUOTES, 'UTF-8');

    // Recuperer le message d'error stocké dans la session (si disponible)
    $message_country_error = htmlspecialchars($_SESSION['message_country_error'] ?? '', ENT_QUOTES, 'UTF-8');
