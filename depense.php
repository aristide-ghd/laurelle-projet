...
<body class="d-flex flex-column min-vh-100">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="modif_form_depense.php?id=<?= $liste['idDepense'] ?>" class="btn btn-primary btn-sm col-lg-5 col-md-12 col-sm-12">Modifier</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Es-tu sûr de vouloir supprimer cette dépense ? <br>
    ...
    <script>
        ...
        deleteModal.addEventListener('show.bs.modal', function (event) {
            ...
            confirmDelete.href = 'delete_depense.php?id=' + idDepense; // Configuration du lien de suppression
        });
    </script>
</body>
</html>